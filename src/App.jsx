...
function QuotaBadge({ quota }) {
  return (
    <div style={{ display: "inline-flex", alignItems: "center", gap: 4, padding: "4px 8px", borderRadius: 999, background: quota > 0 ? "#fff" : C.quotaBg, border: `1px solid ${quota > 0 ? C.borderDark : C.quotaBorder}`, fontSize: 12, color: quota > 0 ? C.text : "#c92a2a", fontWeight: 600, whiteSpace: "nowrap" }}>
      🎫 剩 {quota} 次
    </div>
  );
}
...
if (submitted) {
  return (
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "40px 16px", gap: 16, textAlign: "center", width: "100%", boxSizing: "border-box" }}>
      ...
      <div style={{ padding: "14px 20px", background: "#fff", border: `2px solid #0a8554`, borderRadius: 12, width: "100%", maxWidth: 280, boxSizing: "border-box" }}>
      ...
      <p style={{ color: C.textMuted, fontSize: 13, maxWidth: 260, lineHeight: 1.6, margin: "0 auto" }}>
